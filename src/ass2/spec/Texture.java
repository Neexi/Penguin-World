...
public class Texture {
	...
	public Texture(GL2 gl, String fileName,String extension, float[] color) {
		this(gl,fileName,extension,color,true);
	}
	
	//Create a texture from a file. Make sure the file has a width and height
	//that is a power of 2
	public Texture(GL2 gl, String fileName,String extension, float[] color, boolean mipmaps) {
